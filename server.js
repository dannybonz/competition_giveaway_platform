			...
			result.forEach(function (item, index) { //Loop through all relevant entries
				...
				con.query("SELECT * FROM tblcompetition WHERE `competitionID` = '"+item["competitionID"]+"'", function (err, competition_result, fields) { //Get competition info
					...
					var mailOptions = { 
						...
						html: '<div style="background-image:linear-gradient(to bottom right, #F6C2CB, #730973);width:90%;text-align:center;font-family:sans-serif;padding-top:20px;padding-bottom:10px;border-radius:200px;margin-left: 5%;margin-top:50px;margin-bottom:50px"><img src=\'https://cdn.discordapp.com/attachments/344919769813745674/1099748932772446228/logo.png\' style="width:auto;height:100px;margin-bottom:20px"><br><h1 style="text-align:center;color:white;background-color: rgba(128, 0, 128, 0.1);display:inline-block;padding:15px;border-radius:15px;width:50%">Your submission to '+competition_result[0]["competitionTitle"]+' has been received!<br>Thank you for taking part.</h1><p style="color:white;margin-top:50px;font-weight:bold;font-style:italic;">This email was sent automatically to confirm your entry. You have not been added to a mailing list.</p></div>'
					};
